...
#define REGFLAG_END_OF_TABLE      							0xAA   // END OF REGISTERS MARKER
  ...
  #define TRUE  (1)
#endif
// I chose GPIO_LCD_MAKER_ID in new codegen layout to replace GPIO_LCM_ID
#ifndef GPIO_LCM_ID
  #define GPIO_LCM_ID GPIO_LCD_MAKER_ID
#endif

#ifndef GPIO_LCM_ID_M_GPIO
  #define GPIO_LCM_ID_M_GPIO GPIO_LCD_MAKER_ID_M_GPIO
#endif
// ---------------------------------------------------------------------------
//  Local Variables
// ---------------------------------------------------------------------------
