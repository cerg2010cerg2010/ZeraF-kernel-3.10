...
void VCAMA_LDO_EN_fuc(int enable)
{
       ...
       if(mt_set_gpio_mode(GPIO_CAMERA_LDO_EN_PIN,GPIO_CAMERA_LDO_EN_PIN_M_GPIO))
       {
       ...
       if(enable==1)
       {
               if(mt_set_gpio_out(GPIO_CAMERA_LDO_EN_PIN,GPIO_OUT_ONE))
               {
       ...
       {
               if(mt_set_gpio_out(GPIO_CAMERA_LDO_EN_PIN,GPIO_OUT_ZERO))
               {
